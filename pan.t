...
{	Trans *T;
	...
	trans[3][3]	= settr(239,2,10,8,8,"((proc<3))", 1, 2, 0); /* m: 4 -> 10,0 */
	reached3[4] = 1;
	...
	trans[3][12]	= settr(248,2,25,11,11,"((proc==3))", 1, 2, 0); /* m: 17 -> 25,0 */
	reached3[17] = 1;
	...
	trans[2][2]	= settr(161,0,68,21,0,"((num<3))", 0, 2, 0);
	...
	trans[2][72]	= settr(231,0,74,59,59,"((num==3))", 0, 2, 0); /* m: 73 -> 74,0 */
	reached2[73] = 1;
	...
	trans[1][51]	= settr(100,0,72,79,0,"(((ship_status[shipid]==3)&&(ship_pos[shipid]!=3)))", 1, 2, 0);
	...
	trans[1][79]	= settr(128,2,84,92,92,"(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==3)))", 1, 6, 0); /* m: 80 -> 84,0 */
	reached1[80] = 1;
	...
	trans[1][86]	= settr(135,2,87,94,0,"(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]==2)&&((ship_pos[shipid]+1)!=3)))", 1, 6, 0);
	...
	trans[1][91]	= settr(140,4,107,96,96,"(((doors_status[ship_pos[shipid]].higher==1)&&((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==3))))", 1, 2, 0); /* m: 92 -> 107,0 */
	reached1[92] = 1;
	...
	trans[1][104]	= settr(153,0,105,100,0,"(((ship_status[shipid]==3)&&(ship_pos[shipid]==3)))", 1, 2, 0);
