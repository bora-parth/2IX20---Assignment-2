...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC :init: */
	case 3: // STATE 1 - lock_env_multiple.pml:319 - [(run main_control())] (0:0:0 - 1)
		IfNotBlocked
		reached[3][1] = 1;
		if (!(addproc(II, 1, 2, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - lock_env_multiple.pml:323 - [proc = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 3 - lock_env_multiple.pml:325 - [((proc<4))] (10:0:6 - 1)
		IfNotBlocked
		reached[3][3] = 1;
		...
		;
		_m = 3; goto P999; /* 6 */
	case 6: // STATE 10 - lock_env_multiple.pml:332 - [(run lock(proc))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][10] = 1;
		if (!(addproc(II, 1, 0, ((int)((P3 *)_this)->proc))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 11 - lock_env_multiple.pml:333 - [proc = (proc+1)] (0:0:1 - 1)
		IfNotBlocked
		reached[3][11] = 1;
		(trpt+1)->bup.oval = ((int)((P3 *)_this)->proc);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 12 - lock_env_multiple.pml:334 - [((proc==4))] (25:0:2 - 1)
		IfNotBlocked
		reached[3][12] = 1;
		if (!((((int)((P3 *)_this)->proc)==4)))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 9: // STATE 17 - lock_env_multiple.pml:338 - [proc = 0] (0:25:1 - 3)
		IfNotBlocked
		reached[3][17] = 1;
		(trpt+1)->bup.oval = ((int)((P3 *)_this)->proc);
		((P3 *)_this)->proc = 0;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 10: // STATE 18 - lock_env_multiple.pml:340 - [((proc<2))] (21:0:2 - 1)
		IfNotBlocked
		reached[3][18] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 11: // STATE 21 - lock_env_multiple.pml:341 - [(run ship(proc))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][21] = 1;
		if (!(addproc(II, 1, 1, ((int)((P3 *)_this)->proc))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 22 - lock_env_multiple.pml:341 - [proc = (proc+1)] (0:0:1 - 1)
		IfNotBlocked
		reached[3][22] = 1;
		(trpt+1)->bup.oval = ((int)((P3 *)_this)->proc);
		((P3 *)_this)->proc = (((int)((P3 *)_this)->proc)+1);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 23 - lock_env_multiple.pml:342 - [((proc==2))] (34:0:2 - 1)
		IfNotBlocked
		reached[3][23] = 1;
		if (!((((int)((P3 *)_this)->proc)==2)))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 14: // STATE 28 - lock_env_multiple.pml:346 - [proc = 0] (0:34:1 - 3)
		IfNotBlocked
		reached[3][28] = 1;
		(trpt+1)->bup.oval = ((int)((P3 *)_this)->proc);
		((P3 *)_this)->proc = 0;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 15: // STATE 29 - lock_env_multiple.pml:348 - [((proc<2))] (34:0:2 - 1)
		IfNotBlocked
		reached[3][29] = 1;
		if (!((((int)((P3 *)_this)->proc)<2)))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 16: // STATE 38 - lock_env_multiple.pml:352 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][38] = 1;
	...
	case 17: // STATE 1 - lock_env_multiple.pml:242 - [num = 0] (0:0:1 - 1)
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 2 - lock_env_multiple.pml:244 - [((num<4))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][2] = 1;
	...
	case 19: // STATE 3 - lock_env_multiple.pml:246 - [request_low[num]?1] (0:0:0 - 1)
		...
		_m = 4; goto P999; /* 0 */
	case 20: // STATE 4 - lock_env_multiple.pml:249 - [((doors_status[num].higher==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][4] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].higher==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 5 - lock_env_multiple.pml:249 - [change_doors_pos[num]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][5] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 22: // STATE 6 - lock_env_multiple.pml:249 - [doors_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][6] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 23: // STATE 11 - lock_env_multiple.pml:253 - [((slide_status[num].higher==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][11] = 1;
		if (!((now.slide_status[ Index(((int)((P2 *)_this)->num), 4) ].higher==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 12 - lock_env_multiple.pml:253 - [change_slide_pos[num]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][12] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 25: // STATE 13 - lock_env_multiple.pml:253 - [slide_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][13] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 26: // STATE 18 - lock_env_multiple.pml:257 - [((doors_status[num].lower==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][18] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].lower==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 19 - lock_env_multiple.pml:259 - [(((lock_water_level[num]!=2)&&(slide_status[num].lower==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][19] = 1;
		if (!(((now.lock_water_level[ Index(((int)((P2 *)_this)->num), 4) ]!=2)&&(now.slide_status[ Index(((int)((P2 *)_this)->num), 4) ].lower==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 28: // STATE 20 - lock_env_multiple.pml:259 - [change_slide_pos[num]!2] (0:0:0 - 1)
		IfNotBlocked
		reached[2][20] = 1;
		if (q_full(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 29: // STATE 21 - lock_env_multiple.pml:259 - [slide_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][21] = 1;
		if (q_zero(now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 30: // STATE 22 - lock_env_multiple.pml:259 - [change_doors_pos[num]!2] (0:0:0 - 1)
		IfNotBlocked
		reached[2][22] = 1;
		if (q_full(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 31: // STATE 23 - lock_env_multiple.pml:259 - [doors_pos_changed[num]?1] (33:0:0 - 1)
		reached[2][23] = 1;
		if (q_zero(now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		;
		_m = 4; goto P999; /* 2 */
	case 32: // STATE 24 - lock_env_multiple.pml:261 - [((lock_water_level[num]==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][24] = 1;
		if (!((now.lock_water_level[ Index(((int)((P2 *)_this)->num), 4) ]==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 33: // STATE 25 - lock_env_multiple.pml:261 - [change_doors_pos[num]!2] (0:0:0 - 1)
		IfNotBlocked
		reached[2][25] = 1;
		if (q_full(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 34: // STATE 26 - lock_env_multiple.pml:261 - [doors_pos_changed[num]?1] (33:0:0 - 1)
		reached[2][26] = 1;
		if (q_zero(now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		;
		_m = 4; goto P999; /* 2 */
	case 35: // STATE 32 - lock_env_multiple.pml:265 - [.(goto)] (0:33:0 - 4)
		IfNotBlocked
		reached[2][32] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 29 - lock_env_multiple.pml:263 - [((doors_status[num].lower==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][29] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].lower==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 37: // STATE 30 - lock_env_multiple.pml:263 - [(1)] (33:0:0 - 1)
		IfNotBlocked
		reached[2][30] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 38: // STATE 33 - lock_env_multiple.pml:265 - [observed_low[num]?1] (0:0:0 - 1)
		reached[2][33] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 39: // STATE 35 - lock_env_multiple.pml:267 - [request_high[num]?1] (0:0:0 - 1)
		reached[2][35] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 40: // STATE 36 - lock_env_multiple.pml:270 - [((doors_status[num].lower==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][36] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].lower==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 41: // STATE 37 - lock_env_multiple.pml:270 - [change_doors_pos[num]!2] (0:0:0 - 1)
		IfNotBlocked
		reached[2][37] = 1;
		if (q_full(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 42: // STATE 38 - lock_env_multiple.pml:270 - [doors_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][38] = 1;
		if (q_zero(now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 43: // STATE 43 - lock_env_multiple.pml:274 - [((slide_status[num].lower==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][43] = 1;
		if (!((now.slide_status[ Index(((int)((P2 *)_this)->num), 4) ].lower==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 44: // STATE 44 - lock_env_multiple.pml:274 - [change_slide_pos[num]!2] (0:0:0 - 1)
		IfNotBlocked
		reached[2][44] = 1;
		if (q_full(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 45: // STATE 45 - lock_env_multiple.pml:274 - [slide_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][45] = 1;
		if (q_zero(now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 46: // STATE 50 - lock_env_multiple.pml:278 - [((doors_status[num].higher==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][50] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].higher==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 47: // STATE 51 - lock_env_multiple.pml:280 - [(((lock_water_level[num]!=1)&&(slide_status[num].higher==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][51] = 1;
		if (!(((now.lock_water_level[ Index(((int)((P2 *)_this)->num), 4) ]!=1)&&(now.slide_status[ Index(((int)((P2 *)_this)->num), 4) ].higher==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 48: // STATE 52 - lock_env_multiple.pml:280 - [change_slide_pos[num]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][52] = 1;
		if (q_full(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_slide_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 49: // STATE 53 - lock_env_multiple.pml:280 - [slide_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][53] = 1;
		if (q_zero(now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.slide_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 50: // STATE 54 - lock_env_multiple.pml:280 - [change_doors_pos[num]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][54] = 1;
		if (q_full(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 51: // STATE 55 - lock_env_multiple.pml:280 - [doors_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][55] = 1;
		if (q_zero(now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 52: // STATE 56 - lock_env_multiple.pml:282 - [((lock_water_level[num]==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][56] = 1;
		if (!((now.lock_water_level[ Index(((int)((P2 *)_this)->num), 4) ]==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 53: // STATE 57 - lock_env_multiple.pml:282 - [change_doors_pos[num]!1] (0:0:0 - 1)
		IfNotBlocked
		reached[2][57] = 1;
		if (q_full(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]))
			continue;
		...
		if (q_zero(now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ])) { boq = now.change_doors_pos[ Index(((int)((P2 *)_this)->num), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 54: // STATE 58 - lock_env_multiple.pml:282 - [doors_pos_changed[num]?1] (0:0:0 - 1)
		reached[2][58] = 1;
		if (q_zero(now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]))
		{	if (boq != now.doors_pos_changed[ Index(((int)((P2 *)_this)->num), 4) ]) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 55: // STATE 61 - lock_env_multiple.pml:284 - [((doors_status[num].higher==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][61] = 1;
		if (!((now.doors_status[ Index(((int)((P2 *)_this)->num), 4) ].higher==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 56: // STATE 65 - lock_env_multiple.pml:286 - [observed_high[num]?1] (76:0:1 - 5)
		reached[2][65] = 1;
		...
		;
		_m = 4; goto P999; /* 3 */
	case 57: // STATE 73 - lock_env_multiple.pml:291 - [num = (num+1)] (0:76:1 - 4)
		IfNotBlocked
		reached[2][73] = 1;
		(trpt+1)->bup.oval = ((int)((P2 *)_this)->num);
		((P2 *)_this)->num = (((int)((P2 *)_this)->num)+1);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 58: // STATE 74 - lock_env_multiple.pml:292 - [((num==4))] (76:0:2 - 1)
		IfNotBlocked
		reached[2][74] = 1;
		if (!((((int)((P2 *)_this)->num)==4)))
			continue;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 59: // STATE 79 - lock_env_multiple.pml:294 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][79] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
	...
	case 77: // STATE 41 - lock_env_multiple.pml:175 - [(((doors_status[(ship_pos[shipid]-1)].lower==1)&&((nr_of_ships_at_pos[(ship_pos[shipid]-1)]<2)||((ship_pos[shipid]-1)==0))))] (107:0:4 - 1)
		...
		;
		_m = 3; goto P999; /* 5 */
	case 78: // STATE 51 - lock_env_multiple.pml:182 - [(((ship_status[shipid]==3)&&(ship_pos[shipid]!=4)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][51] = 1;
	...
	case 90: // STATE 78 - lock_env_multiple.pml:208 - [((doors_status[ship_pos[shipid]].higher==1))] (0:0:0 - 1)
		...
		if (!((now.doors_status[ Index(((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ]), 4) ].higher==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 91: // STATE 79 - lock_env_multiple.pml:211 - [(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==4)))] (84:0:4 - 1)
		IfNotBlocked
		reached[1][79] = 1;
	...
	case 92: // STATE 84 - lock_env_multiple.pml:216 - [observed_high[(ship_pos[shipid]-1)]!1] (0:0:0 - 1)
		...
		if (q_zero(now.observed_high[ Index((((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ])-1), 4) ])) { boq = now.observed_high[ Index((((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ])-1), 4) ]; };
		_m = 2; goto P999; /* 0 */
	case 93: // STATE 86 - lock_env_multiple.pml:219 - [(((nr_of_ships_at_pos[(ship_pos[shipid]+1)]==2)&&((ship_pos[shipid]+1)!=4)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][86] = 1;
		if (!(((((int)now.nr_of_ships_at_pos[ Index((((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ])+1), 5) ])==2)&&((((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ])+1)!=4))))
			continue;
	...
	case 94: // STATE 87 - lock_env_multiple.pml:220 - [observed_high[ship_pos[shipid]]!1] (0:0:0 - 1)
		...
		_m = 2; goto P999; /* 0 */
	case 95: // STATE 91 - lock_env_multiple.pml:224 - [(((doors_status[ship_pos[shipid]].higher==1)&&((nr_of_ships_at_pos[(ship_pos[shipid]+1)]<2)||((ship_pos[shipid]+1)==4))))] (107:0:4 - 1)
		IfNotBlocked
		reached[1][91] = 1;
	...
	case 98: // STATE 103 - lock_env_multiple.pml:232 - [ship_status[shipid] = 3] (0:0:1 - 1)
		...
		;
		_m = 3; goto P999; /* 0 */
	case 99: // STATE 104 - lock_env_multiple.pml:233 - [(((ship_status[shipid]==3)&&(ship_pos[shipid]==4)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][104] = 1;
		if (!(((now.ship_status[ Index(((int)((P1 *)_this)->shipid), 2) ]==3)&&(((int)now.ship_pos[ Index(((int)((P1 *)_this)->shipid), 2) ])==4))))
			continue;
